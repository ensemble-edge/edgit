 ...
 * ```
 */
export async function input(message: string, options: PromptOptions = {}): Promise<string> {
  const rl = createInterface()
...
export class InteractivePrompt {
   ...
   */
  async select<T>(message: string, choices: T[], options: SelectOptions<T> = {}): Promise<T> {
 ...
 */
export function createPrompt(interactive = true): InteractivePrompt {
