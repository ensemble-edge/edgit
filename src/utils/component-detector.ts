...
export class ComponentDetector {
   ...
   */
  detectComponent(filePath: string): { type: ComponentType; name: string } | null {
   ...
   */
  async getChangedComponents(fromRef?: string, toRef?: string): Promise<{
    type: ComponentType;
    name: string;
    path: string;
   ...
   */
  async getStagedComponents(): Promise<{
    type: ComponentType;
    name: string;
    path: string;
    action: 'added' | 'modified' | 'deleted';
   ...
   */
  async getComponentsByType(type: ComponentType): Promise<{
    name: string;
    path: string;
  }[]> {
   ...
   */
  async findComponentByName(name: string): Promise<{
    type: ComponentType;
    name: string;
    path: string;
  } | null> {
