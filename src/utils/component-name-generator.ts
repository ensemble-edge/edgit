...
export class ComponentNameGenerator {
   ...
   */
  private static checkCollision(candidateName: string, existingComponents?: Record<string, any>): {
    detected: boolean;
    suggestions: string[];
  } | undefined {
   ...
   */
  private static cleanBaseName(baseName: string): string {
    return baseName
   ...
   */
  static validateWorkerName(name: string): { valid: boolean; errors: string[] } {
    const errors: string[] = [];
