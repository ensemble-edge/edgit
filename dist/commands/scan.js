  ...
  edgit scan --output json          # JSON output for scripting
    ...
    calculateConfidence(file, type) {
        ...
        if (highConfidencePatterns[type]) {
            for (const pattern of highConfidencePatterns[type]) {
        ...
        if (mediumConfidencePatterns[type]) {
            for (const pattern of mediumConfidencePatterns[type]) {
