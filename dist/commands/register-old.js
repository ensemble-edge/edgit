...
Note: Headers are added by default for hybrid versioning. Use --without-header to opt out.
    ...
    async registerComponent(filePath, options) {
    ...
    generateComponentName(filePath, type, existingComponents) {
    ...
    async promptForName(suggestedName) {
        const rl = readline.createInterface({
            input: process.stdin,
            output: process.stdout
        });
...
//# sourceMappingURL=register-old.js.map