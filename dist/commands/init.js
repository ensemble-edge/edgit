...
export class InitCommand extends Command {
    ...
    async scanExistingComponents(repoRoot, options = {}) {
        ...
        for (const detected of detectedComponents) {
            ...
            const component = await ComponentUtils.createComponentWithWorkerName(detected.path, detected.type, currentCommit, 'init-scan', // Simple context
