...
export class GitTagManager {
     ...
     * @returns SHA hash
     */
    async getTagSHA(component, tagName) {
        const gitTag = `components/${component}/${tagName}`;
     ...
     */
    async tagExists(component, tagName) {
        try {
     ...
     * @param message Optional tag message
     */
    async moveDeploymentTag(component, env, targetRef, message) {
     ...
     * @param message Optional tag message
     */
    async createVersionTag(component, version, sha, message) {
     ...
     * @returns SHA hash
     */
    async resolveRef(component, ref) {
     ...
     */
    async deleteTag(component, tagName, deleteRemote = false) {
        const gitTag = `components/${component}/${tagName}`;
        // Delete local tag
     ...
     */
    async getFileAtTag(component, tagName, filePath) {
